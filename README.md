...
<br/><br/>⚠️ **WARNING:** This only works when account credentials are provided to the client. Subscription events and information are hidden behind account authentication by TikTok.
