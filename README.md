...
| Item                                      | Price (CAD)                                                                   | Price (USD)   | Description                                                                                                                                                                                                                                                      |
|-------------------------------------------|-------------------------------------------------------------------------------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Donation Sounds                           | CA$ 7                                                                         | ~ $5          | Play custom sound files (mp3/wav/etc.) when a user donates to your stream with specific gifts (Rose, Sunglasses, etc.)                                                                                                                                           |
| Text Command System                       | CA$ 7                                                                         | ~ $5          | Using the same style handling as this library, parse text messages into Amazon Echo styled commands you can handle with an assortment of response options including playing a wav or text-to-speech, or custom response.                                         |
| Combined Text & Donation Sounds           | CA$ 10                                                                        | ~ $8          | Everything that "Donation Sounds" and "Text Command System" does, but combined into one singular program.                                                                                                                                                        |
| TikTok Chat to Twitch Chat Conversion Bot | CA$ 10                                                                        | ~ $8          | Send all TikTok chats to a Twitch channel's chat using a stream moderator/operator account on Twitch.                                                                                                                                                            |
| Custom Option                             | Contact for a quote                                                           | N/A           | See something not on here? Contact for a custom quote. Please not that we reserve the right to add your commission to this shop for others to purchase after it is done. The goal of this shop is to support charity, so the more purchasable items, the better. |
| Donation                                  | Choose your contribution                                                      | N/A           | Donate to the fund for the sake of it. Every dollar makes a difference.                                                                                                                                                                                          |

### Thermal Printing

| Item        | Price (CAD) | Conversion (USD) | Description                                                                                                                                                                                                                                                                   |
|-------------|-------------|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Coming Soon | CA$ 32      | ~ $25            | Coming Soon                                                                                                                                                                                                                                                                   |
| Standard    | CA$ 40      | ~ $30            | Print events to a Thermal Printer. For example, printing a comment with the user's name, message, and profile picture. This is a HIGHLY advanced wrapper allowing you to print to a USB printer (must have ESCPOS) like it's nothing.                                         |
| Coming Soon | CA$ 70      | ~ $55            | Coming Soon                                                                                                                                                                                                                                                                   |                        |                                                                              |                              |                                                                                                                                                                                                                                       |
| Setup Help  | CA$ $15     | ~ $10            | Up to 45 minutes of 1-on-1 setup time. I will conference with you in a voice call on Discord and remotely control your PC via AnyDesk. I will install the software on the spot, with you. Must have a working phone with Discord, so I can see the printer in case I need to. |
